...
用法：
    ...
    python experiments/glove/attention_lstm.py
    python experiments/glove/attention_lstm.py --show-attention 6 --top-words 12
    python experiments/glove/attention_lstm.py --predict "The ending ruined an otherwise great film."
"""
